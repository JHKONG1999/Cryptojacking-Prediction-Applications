...
selected =option_menu(
  menu_title=None,
  options=["Dashboard","Predicts","Heatmap","About"],
  icons=["house","shield-check","graph-up","justify"],
  menu_icon="cast",
  default_index=0,
...
#---ABOUT INTERFACE---
if selected =="About":
  #Display info and user guides
  st.header("**What is Crytojacking?**")
  st.header("**How is this application works?**")
  st.header("**Reference Articles:**")
